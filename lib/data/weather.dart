...
//constructor
  Weather.fromJson(Map<String, dynamic> weatherMap) {
    ...
    //this.temperature = (weatherMap['main']['temp'] * (9/5)-459.67) ?? 0; // convert kelvin to farenheit
    temperature =
        (weatherMap['main']['temp'] - 273.15) ?? 0; // convert kelvin to celsius
